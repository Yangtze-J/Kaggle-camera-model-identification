...
from Augment.Operations import *
from Augment.ImageUtilities import scan_directory, scan, AugmentorImage
...
class Pipeline(object):
    ...
    def _execute(self, augmentor_image, manipulated, save_to_disk=True):
        """
        ...
        for operation in self.operations:
            ...
            if r <= operation.probability:
                image, manipulated = operation.perform_operation(image, manipulated)
    ...
    def keras_generator(self, batch_size, image_data_format="channels_last"):
        ...
        while True:
            ...
            for i in range(batch_size):
                ...
                numpy_array, manipulated = self._execute(self.augmentor_images[random_image_index], self.manipulated, save_to_disk=False)
